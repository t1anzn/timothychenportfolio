...
const projects = [
  ...
  },
  {
    ...
    images: [
      ...
      {
        src: "/mandarin-ppt-slides.png",
        alt: "Slides generated by the Mandarin Powerpoint Generator",
        caption: "Slides generated by the Mandarin Powerpoint Generator",
      },
    ],
    slug: "mandarin-ppt-generator",
    description:
      "A desktop application that generates PowerPoint presentations for Mandarin vocabulary learning, featuring automatic translation, pinyin, audio, and visual enhancements.",
    features: [
    ...
    challenges:
      "Handling PowerPoint automation, integrating translation and text-to-speech APIs, supporting both English and Chinese interfaces, and working around PowerPoint's limited programming support.",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <style jsx>{`
        ...
        .image-container img[src*="mandarin-ppt-slides"] {
          max-width: 350px;
          max-height: 600px;
          width: auto;
          height: auto;
